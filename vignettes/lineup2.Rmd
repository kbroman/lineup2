...
Let's pull out the five problem samples (plus one other, for reasons that
will soon be clear), and plot the values in each
column, pointing to the maximum in red and the self value in green.
...
gastroc. The sample labelled Mouse3296 in islet is a really an
